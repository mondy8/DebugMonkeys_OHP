      ...
      <li class="contents__detail-list" v-for="(game, index) in game" :key=index :id="'gamelist-' + index">
        ...
        <div class="contents__detail-inner">
          ...
          <ul class="contents__detail-btn">
            <li v-if="game.soldout" class="contents__detail-btn--buy contents__detail-btn--soldout">完売</li>
            <li v-else class="contents__detail-btn--buy"><a :href=game.booth target="_blank">購入する</a></li>
            <li class="contents__detail-btn--info"><router-link v-bind:to="{ name: 'detail', params:{ id: game.type }}">詳細を見る</router-link></li>
          </ul>
        </div>
      </li>
    </ul>
